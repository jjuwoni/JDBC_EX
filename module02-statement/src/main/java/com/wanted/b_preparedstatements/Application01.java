...
public class Application01 {
    public static void main(String[] args) {
        ...
        /* comment.
         *   Statement 는 SQL 쿼리문을 실행할 때마다 SQL 문이 DBMS 에 전송 되어
         *   DBMS 에서 SQL 구문을 파싱(번역)하고 컴파일 하는 과정을 거치게 된다.
         *   PreparedStatement 는 최초에 한 번 실행 시,
         *   SQL 구문을 파싱하고 컴파일 하는 것은 동일하지만
         *   동일한 구문을 여러 번 실행하면, 최초에 컴파일 한 SQL 을 재사용하게 된다.
